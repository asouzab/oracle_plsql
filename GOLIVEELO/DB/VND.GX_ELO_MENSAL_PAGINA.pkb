CREATE OR REPLACE PACKAGE BODY VND.GX_ELO_MENSAL_PAGINA AS
...
--                            on ag.CD_ELO_AGENDAMENTO = prodloss.CD_ELO_AGENDAMENTO
                    ...
                    where   ( ag.DT_WEEK_START BETWEEN P_DT_DE AND P_DT_ATE )
                                and
                            ( ag.DT_WEEK_START BETWEEN P_DT_DE AND P_DT_ATE )
                                AND
